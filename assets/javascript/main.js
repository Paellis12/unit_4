$( document ).ready(function(){
    //Creates the random number (hopefully) in between 17-120 to be shown upon start of the game.//
    var randomNumber = Math.floor(Math.random()*103+17)  
    ...
    //We will also console.log the random number being generated for checking purposes//
      function reset() {
        ...
        $("#randomNum").text(randomNumber);
         ...
         jewel4 = Math.floor(Math.random()*15+1)
         total = 0;
